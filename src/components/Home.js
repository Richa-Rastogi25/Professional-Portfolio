  ...
  return (
    <div style={{paddingLeft:'100px', paddingTop:'100px'}}>
        ...
        <div className="rotator-container">
            ...
            <div className="text-rotator">Aspiring Software Developer</div>
            <div className="text-rotator">E-Commerce Professional</div>
            <div className="text-rotator">Banking and Insurance Professional</div>
        </div>
